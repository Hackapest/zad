...
filtered_signal = lowpass_filter(signal, initial_cutoff_frequency, sampling_frequency)
...
def update_data(attrname, old, new):
    ...
    new_filtered_signal = lowpass_filter(new_signal, cutoff_slider.value, sampling_frequency)
...
controls = column(amplitude_slider, frequency_slider, phase_slider, noise_mean_slider, noise_covariance_slider,
                  cutoff_slider, show_noise_checkbox, reset_button, adjust_noise_button, plot_type_select)
